...
int main() 
{
    ...
    if (scale == "fahrenheit")
    {
        ...
        cout << fahrenheit << " degrees fahrenheit is equivalent to " << celsius << " degrees celsius and " << kelvin << " degrees kelvin.\n";
    }
    else if (scale == "celsius")
    {
        ...
        cout << celsius << " degrees celsius is equivalent to " << fahrenheit << " degrees fahrenheit and " << kelvin << " degrees kelvin.\n";
    }
    else if (scale == "kelvin")
    {
        ...
        double fahrenheit = (celsius * (9.0/5)) + 32;
        cout << kelvin << " degrees kelvin is equivalent to " << fahrenheit << " degrees fahrenheit and " << celsius << " degrees celsius.\n";
    }
    else 
    {
